    ...
    return (
      <header className="container fixed top-0 left-0 right-0 z-20 flex items-center justify-between p-8 mx-auto">
        <div className="flex items-center flex-1">
          <Link href="/">
            <a className="flex w-24 h-24 text-yellow-400 rounded-full rise focus:ring ring-yellow-500 ring-opacity-50" aria-label="Home">
        ...
        <div className="items-center justify-end hidden py-4 pl-12 pr-4 bg-gray-900 rounded-full shadow-md sm:flex">
          <div className="flex items-center space-x-6 navigation">
            <NavLink href="/">
              {({ active }) => (
                <a className={`flex items-center leading-8 border-b-2 border-transparent transition duration-200 ease-in-out hover:text-white focus:text-white group ${active ? 'text-white active' : 'text-gray-500'}`}>
          ...
          <a className="flex items-center px-6 py-3 ml-6 text-yellow-900 uppercase bg-yellow-400 rounded-full group rise hover:bg-yellow-300 hover:text-yellow-800 focus:ring ring-yellow-500 ring-opacity-50" href="mailto:hi@sammagee.me">
            <span className="mt-1">Contact</span>

            <svg className="w-4 ml-2 text-yellow-700 transition-all duration-200 ease-in-out transform fill-current group-hover:text-yellow-600 group-hover:translate-x-1 group-focus:translate-x-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div className="relative inline-block mr-8 text-left sm:hidden">
          <Menu>
            {({ open }) => (
              <>
                <Menu.Button className={`flex items-center justify-center rounded-full w-16 h-16 -mr-5 transition duration-200 ease-in-out border-none shadow select-none focus:outline-none group focus:ring ring-yellow-500 ring-opacity-50 ${open ? 'z-30' : 'bg-gray-900 rise'}`}>
                    ...
                    >
                      ...
                      <div className="divide-y divide-gray-800">
                        ...
                        <div>
                          ...
                          <Menu.Item>
                            <a className="flex items-center justify-between px-6 py-3 text-xl leading-none text-yellow-900 bg-yellow-400 contact-button hover:bg-yellow-300 hover:text-yellow-800 group focus:ring ring-yellow-500 ring-opacity-50" href="mailto:hi@sammagee.me">
                              <span className="mt-1">Contact</span>
